...
<section>
<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-white-900">
  <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          <header class="mb-4 lg:mb-6 not-format">
              <address class="flex items-center mb-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white pl-7">
                      <img class="mr-8 w-25 h-100" src="https://images.squarespace-cdn.com/content/v1/5ef17f0e214de870914df617/1618342005933-DCRALEZJH9UC0RCXA1XD/IMG_6502.JPG?format=1500w" alt="Joan Laxmie Rupram">
                </div>
              </address>
                    <div>
              ...
              <h1 class="mb-6 text-4xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">Joan's Bio</h1>
          </header>
          <div name="Joan intro">
        ...
        <div name='p1'>
            <h1 class="mb-2 text-2xl font-extrabold leading-tight text-gray-900 lg:mb-3 lg:text-2xl dark:text-black">2015 -  How do you express self-love/care in the face of racism/anti-Blackness/anti-Indigeneity?
            </h1>
            <p>
        ...
        <div name='p1'>
            <h1 class="mb-2 text-2xl font-extrabold leading-tight text-gray-900 lg:mb-3 lg:text-2xl dark:text-black">2023 - Reflectively, how do you feel about this response now? What has changed, what hasn’t? ( in terms of how you view self-care as it pertains to your own wellness and generally in society?)
            </h1>
            <div class="pb-1"></div>
             <p class="mb-1 text-sm font-extrabold leading-tight text-gray-700 lg:mb-3 lg:text-sm dark:text-black"></p>
             <div class="pb-4"></div>
            <p>
